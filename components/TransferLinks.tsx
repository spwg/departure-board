 ...
 *
 * It appears only where a stop has known transfer destinations, and it opens
 * each target station board starting after this train's own live arrival. It makes
    ...
    <div className="mt-1 flex flex-wrap gap-1.5">
      {transfer.targets.map((target) => (
        <Link
          ...
          aria-label={`Transfer to ${target.label} at ${target.stationName} after this train arrives`}
